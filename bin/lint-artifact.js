...
import { parseArgs } from '../src/scripts/lib/cli.js';
import { readYaml } from '../src/scripts/lib/yaml-io.js';
import {
  validateContract,
  runChecks,
} from '../src/scripts/lib/contract-checks.js';
import { requireContract, makeCtx } from '../src/scripts/lib/context.js';
import { validateArtifactSchema } from '../src/scripts/lib/schema.js';
import { makeError } from '../src/scripts/lib/error-catalog.js';
    ...
    JSON.stringify(
      {
        ...
        examples: [
          'node bin/lint-artifact.js --contract requirements --artifact docs/changes/my-change/requirements.yaml',
          'node bin/lint-artifact.js --contract plan --artifact docs/changes/my-change/plan.yaml --gate review',
          'node bin/lint-artifact.js --contract implementation --artifact docs/changes/my-change/plan.yaml --gate review',
        ],
      },
      null,
      2
