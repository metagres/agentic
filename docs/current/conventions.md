...
| docs/current index contract: exactly four columns (File, Purpose, When to Read, Notes) and nine fixed document rows; no overview.md; created only by the knowledge-init skill, maintained by knowledge extraction and the docs-gen tooling | src/skills/knowledge-init/SKILL.md, docs-gen.yaml |
