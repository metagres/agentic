...
import { parseArgs, writeJson, EXIT } from './cli.js';
import {
  resolveRootOrError,
  ResolveRootError,
...
import { today, slugify, uniqueSlug } from './ids.js';
import { bumpVersion } from './semver.js';
import { requirementsStage } from '../workflows/requirements.js';
import { designStage } from '../workflows/design.js';
import { planningStage } from '../workflows/planning.js';
import { loadLifecycle, loadSemanticPolicy } from './policy-loader.js';
import { assertTransition } from './lifecycle.js';
import { makeError } from './error-catalog.js';
...
function cliInvocation(cwd) {
  ...
  if (!scriptPath) {
    return 'node src/scripts/sdlc.js';
  }
