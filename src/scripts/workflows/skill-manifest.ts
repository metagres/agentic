...
'node "$SDLC_CLI" planning --dir <change-dir> --strict',
  ...
  },
  {
    ...
    commands: [
      ...
      'node "$SDLC_CLI" implementation --dir <change-dir> --task-id TASK-001 --status done --note "Implemented and verified" --files "create:src/a.ts,modify:src/b.ts"',
...
'node "$SDLC_CLI" knowledge-extraction --dir <change-dir> --strict',
