#!/usr/bin/env node
import { writeJson, EXIT } from './lib/cli.js';
import { resolveWorkflow, listWorkflows } from './workflows/index.js';
import { runStatus } from './workflows/status.js';
// sdlc-hardening: utilities
import { runDoctor } from './workflows/doctor.js';
import { runDocsInit } from './workflows/docs-init.js';
